...
LogArea::LogArea(MyTab *parent, const FileView& fileView, std::shared_ptr<Highlighter> highlighter) :
    ...
    highlighterDocument{HighlitherDocument(*document(), highlighter)}
{
    MEASURE_FUNCTION();
